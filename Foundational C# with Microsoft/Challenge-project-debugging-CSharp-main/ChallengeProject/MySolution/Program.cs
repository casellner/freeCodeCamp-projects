...
{
    int twentiesBefore = cashTill[3];
    int tensBefore = cashTill[2];
    int fivesBefore = cashTill[1];
    int onesBefore = cashTill[0];
    ...
    if (changeNeeded > 0)
    {
        // reset Till to what it was before
        cashTill[3] = twentiesBefore;
        cashTill[2] = tensBefore;
        cashTill[1] = fivesBefore;
        cashTill[0] = onesBefore;
